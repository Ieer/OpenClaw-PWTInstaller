...
- Documents, durable drafts, and HTML slide sources -> `docs/`
- Images, screenshots, thumbnails, audio/video -> `media/`
- Final PPTX/PDF/HTML/ZIP deliverables -> `exports/` or `outbox/`
- One-off helpers and generators -> `scripts/`
- Node dependencies, package metadata, OCR models, fonts, local packages -> `runtime-assets/`
