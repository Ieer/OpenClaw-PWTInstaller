...
metadata:
	openclaw:
		homepage: https://github.com/Ieer/OpenClaw-PWTInstaller/tree/main/.github/skills/pycaret-automl
		os:
			- win32
			- darwin
			- linux
...
5. Run `setup`, `compare_models`, `tune_model`, and `finalize_model`.
6. Generate predictions for holdout data, future periods, or what-if scenarios.
7. Deliver metrics, business conclusions, risks, and handoff documentation.
...
- Chinese teaching-oriented workflow notes: ../../../examples/skills/automl/README.md