...
- Name: `PyCaret AutoML`
- Version: `0.1.0`
- Tags: `latest,automl,pycaret,forecasting,classification,regression,time-series,demand-planning`
...
clawhub publish ./pycaret-automl \
  ...
  --version 0.1.0 \
  --tags latest,automl,pycaret,forecasting,classification,regression,time-series,demand-planning \
  --changelog "Initial public release of the PyCaret AutoML skill package"
```
